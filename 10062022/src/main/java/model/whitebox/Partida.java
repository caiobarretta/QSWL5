...
public class Partida {
	...
	public void setTimeVisitante(String timeVisitante) throws Exception {
		if(EhUmNomeInvalido(timeVisitante))
			throw new Exception("Nome do time visitante inválido.");
	...
	public void setTimeMandante(String timeMandante) throws Exception {
		if(EhUmNomeInvalido(timeMandante))
			throw new Exception("Nome do time mandante inválido.");
	...
	public boolean estaDisponivelReceberApostas() {
		return this.status == "apostas_abertas" && !EhUmNomeInvalido(this.timeVisitante) && !EhUmNomeInvalido(this.timeMandante);
	}
	...
	private boolean EhUmNomeInvalido(String nome)
	{
